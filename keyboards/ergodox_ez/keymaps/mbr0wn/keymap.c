 ...
 *
 * ,--------------------------------------------------.       ,--------------------------------------------------.
 * |  L1    | 1  ! | 2  @ | 3  # | 4  $ | 5  % | Lang |       | Esc  | 6  ^ | 7  & | 8  * | 9  ( | 0  ) | Bckspc |
 * |--------+------+------+------+------+-------------|       |------+------+------+------+------+------+--------|
 * |  Tab   |   Q  |   W  |   E  |   R  |   T  |  L2  |       |  L2  |   Y  |   U  |   I  |   O  |   P  | - _    |
 * |--------+------+------+------+------+------|      |       |      |------+------+------+------+------+--------|
 * |  Esc   |   A  |   S  |  D   |   F  |   G  |------|       |------|   H  |   J  |   K  |   L  | ;  : |  ' "   |
 * |--------+------+------+------+------+------|  L1  |       |  L1  |------+------+------+------+------+--------|
 * | LShift |Ctrl/Z|   X  |   C  |   V  |   B  |      |       |      |   N  |   M  | ,  < | . >  |AGr//?| RShift |
 * `--------+------+------+------+------+-------------'       `-------------+------+------+------+------+--------'
 *   | Ctrl | `  ~ | ' "  | \  | | LGui |                                   | Ctrl | =/+  | [  { | ]  } |  - _ |
 *   `----------------------------------'                                   `----------------------------------'
 *                                        ,--------------.   ,---------------.
 ...
 *                                 ,------|-------|------|   |-------+-------+------.
 *                                 |      |       | VolD |   | VolUp |       |      |
 *                                 |Space | Alt   |------|   |-------| Space |Enter |
 *                                 |      |       | Del  |   | PgDwn |       |      |
 *                                 `---------------------'   `----------------------'
 */
[BASE] = LAYOUT_ergodox(  // layer 0 : default
  // left hand
  MO(1),      KC_1,    KC_2,     KC_3,     KC_4,   KC_5,  LANG_SWITCH,
  KC_TAB,     KC_Q,    KC_W,     KC_E,     KC_R,   KC_T,  MO(2),
  KC_ESC,     KC_A,    KC_S,     KC_D,     KC_F,   KC_G,
  KC_LSFT, LCTL_T(KC_Z),  KC_X,  KC_C,     KC_V,   KC_B,  MO(1),
  KC_LCTL,    KC_GRV,  KC_QUOT,  KC_BSLS,  KC_LGUI,
  ...
  MO(2),   KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,      KC_MINS,
           KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,   KC_QUOT,
  MO(1),   KC_N,     KC_M,     KC_COMM,  KC_DOT,   ALGR_T(KC_SLSH),   KC_RSFT,
                     KC_LCTL,  ALGR_T(KC_EQL),   KC_LBRC,  KC_RBRC,   KC_MINS,
